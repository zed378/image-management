...
Specify tags for the Image Management & Delivery Platform. Free-form or controlled-vocabulary labels attached many-to-many to assets, indexed for filtering in the Search API.
