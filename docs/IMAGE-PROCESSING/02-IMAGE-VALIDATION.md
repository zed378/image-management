...
Specify image validation for the Image Management & Delivery Platform. Reject invalid uploads before they consume processing resources: MIME type sniffing (not trusting the client-supplied Content-Type), file size limits, dimension limits, and malformed-file detection.
...
- Reject invalid uploads before they consume processing resources: MIME type sniffing (not trusting the client-supplied Content-Type), file size limits, dimension limits, and malformed-file detection.
