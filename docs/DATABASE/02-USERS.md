...
Specify users for the Image Management & Delivery Platform. Human accounts that authenticate to the dashboard; distinct from API keys, which authenticate machine/consumer-application traffic.
...
- Human accounts that authenticate to the dashboard; distinct from API keys, which authenticate machine/consumer-application traffic.
