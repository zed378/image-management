# 07 - Asset Collections

> Category: **Asset Management** (`docs/ASSET/`) &nbsp;|&nbsp; Status: Draft specification &nbsp;|&nbsp; Owner: TBD

## Purpose

Specify asset collections for the Image Management & Delivery Platform. A named, ordered or unordered set of assets that can span folders -- used for e.g. "homepage banners" or "product gallery 42" -- distinct from a folder's strict hierarchy.
...
- A named, ordered or unordered set of assets that can span folders -- used for e.g. "homepage banners" or "product gallery 42" -- distinct from a folder's strict hierarchy.
