...
Specify admin api for the Image Management & Delivery Platform. Endpoints reserved for platform operators, never exposed to tenant API keys: tenant management, plan overrides, global usage dashboards, and emergency asset takedown.
...
- Endpoints reserved for platform operators, never exposed to tenant API keys: tenant management, plan overrides, global usage dashboards, and emergency asset takedown.
