...
Specify metadata & exif for the Image Management & Delivery Platform. Define what EXIF/IPTC/XMP metadata is read (for orientation and copyright), what is stripped from delivered derivatives by default, and the opt-in parameter to preserve it.
...
- Define what EXIF/IPTC/XMP metadata is read (for orientation and copyright), what is stripped from delivered derivatives by default, and the opt-in parameter to preserve it.
