...
Specify api versioning for the Image Management & Delivery Platform. Define the versioning scheme (URL path /v1/ vs. header), the deprecation policy, and how long a deprecated version stays supported before removal.
