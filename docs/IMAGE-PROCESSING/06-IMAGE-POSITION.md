...
Specify image position for the Image Management & Delivery Platform. Support named positions (top, bottom, left, right, center and the four corners) as the simple case, layered under focal point and auto-crop for the smart cases.
...
- Support named positions (top, bottom, left, right, center and the four corners) as the simple case, layered under focal point and auto-crop for the smart cases.
