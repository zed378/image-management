...
Specify retention policy for the Image Management & Delivery Platform. Define how long soft-deleted assets, derivatives, logs, and webhook delivery records are kept before permanent purge, and who (self-serve vs. platform admin) can extend or shorten that window per plan tier.
