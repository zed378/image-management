...
Specify security requirements for the Image Management & Delivery Platform. State each requirement as a testable statement ("the system SHALL..."), tagged MUST/SHOULD/MAY, with a stable ID so TASKS/ and tests can reference it directly.
