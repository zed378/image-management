...
Specify quality control for the Image Management & Delivery Platform. Define the quality parameter's scale (1-100), its meaning per output format (lossy formats only), and the platform default when the client omits it.
...
- Define the quality parameter's scale (1-100), its meaning per output format (lossy formats only), and the platform default when the client omits it.
