...
Specify image crop for the Image Management & Delivery Platform. Define crop as width+height+fit=cover (or crop=) combined with a position/gravity/focal-point parameter that decides which region of the source is kept.
