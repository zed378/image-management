...
Specify folders for the Image Management & Delivery Platform. A hierarchical, user-defined organization structure per project, orthogonal to storage's physical object naming.
