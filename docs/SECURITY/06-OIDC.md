...
Specify openid connect for the Image Management & Delivery Platform. If federated login for the dashboard is in scope, define supported identity providers and how an OIDC identity maps to a platform User record.
...
- If federated login for the dashboard is in scope, define supported identity providers and how an OIDC identity maps to a platform User record.
