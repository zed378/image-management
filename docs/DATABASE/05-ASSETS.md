...
Specify assets for the Image Management & Delivery Platform. The core resource: id, owning project, current version pointer, visibility, status, checksum, dimensions, content-type, size, created/updated timestamps.
...
- The core resource: id, owning project, current version pointer, visibility, status, checksum, dimensions, content-type, size, created/updated timestamps.
