...
export const ERROR_CODES = {
  ...
  invalid_transform_param: {
    status: 400,
    retryable: false,
    message: "A transformation parameter is invalid.",
  },
  ...
  bulk_batch_too_large: {
    status: 400,
    retryable: false,
    message: "The batch contains too many items.",
  },
  ...
  signature_required: {
    status: 403,
    retryable: false,
    message: "This image requires a signed URL.",
  },
  ...
  application_not_found: {
    status: 404,
    retryable: false,
    message: "No application with that id exists.",
  },
  ...
  asset_version_not_found: {
    status: 404,
    retryable: false,
    message: "No asset version with that id exists.",
  },
  derivative_not_found: {
    status: 404,
    retryable: false,
    message: "No derivative exists for this request.",
  },
  folder_not_found: { status: 404, retryable: false, message: "No folder with that id exists." },
  collection_not_found: {
    status: 404,
    retryable: false,
    message: "No collection with that id exists.",
  },
  ...
  upload_incomplete: {
    status: 422,
    retryable: false,
    message: "The upload has not been completed.",
  },
  url_fetch_failed: {
    status: 422,
    retryable: false,
    message: "The image could not be fetched from the URL.",
  },
  ...
  quota_exceeded: {
    status: 429,
    retryable: false,
    message: "The plan quota for this period is exhausted.",
  },
