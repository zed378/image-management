...
Specify cdn testing for the Image Management & Delivery Platform. Define how derivatives reach the edge: origin shield, cache key composition, TTL policy, and purge/invalidation API.
