...
Specify color profile for the Image Management & Delivery Platform. Define ICC color profile handling: convert to sRGB by default for web delivery, with an opt-in to preserve the original profile for print/professional use cases.
...
- Define ICC color profile handling: convert to sRGB by default for web delivery, with an opt-in to preserve the original profile for print/professional use cases.
