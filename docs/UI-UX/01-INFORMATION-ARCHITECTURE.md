...
Specify information architecture for the Image Management & Delivery Platform. Map every dashboard screen to the API endpoints it calls and the primary user task it serves, before any visual design work starts.
...
- Map every dashboard screen to the API endpoints it calls and the primary user task it serves, before any visual design work starts.
