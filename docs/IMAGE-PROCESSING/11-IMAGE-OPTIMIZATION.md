...
Specify image optimization for the Image Management & Delivery Platform. Beyond format/quality, define lossless-safe optimizations always applied: metadata stripping (unless explicitly requested to keep), chroma subsampling, and progressive/interlaced encoding for applicable formats.
